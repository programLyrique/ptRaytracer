...
int main(int argc, char** argv)
{
	...
	scene.addMesh(new rt::Sphere(rt::Position(0, 15, 0), 3, rt::Texture(rt::color::WHITE, rt::color::WHITE, 1000, 1, 1)));
	scene.addMesh(new rt::Sphere(rt::Position(0, 20, 2), 3, rt::Texture(rt::color::WHITE, rt::color(255,255,0), 1000, 0, 1)));
