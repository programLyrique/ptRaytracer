...
int main(int argc, char** argv)
{
	...
	{
		scene.addSolid(new rt::Sphere(rt::Point(0 * cos(k), 20 + 35* cos(k), 25 * cos(k) ), 3, rt::Texture(rt::color::BLACK, rt::color::BLUE, 1000, 0, 1)));
	}
	scene.addSolid(new rt::Plan(rt::Texture(rt::color::WHITE, rt::color::WHITE, 1, 0, 1), rt::Point(0, 0, 10), rt::vector(0, 0, -1)));
	scene.addSolid(new rt::Sphere(rt::Point(3, 20, 0), 3, rt::Texture(rt::color::WHITE, rt::color(255, 255, 0), 1000, 0, 1)));
	scene.addSolid(new rt::Sphere(rt::Point(-3, 20, 3), 3, rt::Texture(rt::color::WHITE, rt::color(255, 0, 255), 1000, 0, 1)));
	scene.addSolid(new rt::Sphere(rt::Point(3, 20, 6), 3, rt::Texture(rt::color::WHITE, rt::color(0, 255, 255), 1000, 0, 1)));
	scene.addSolid(new rt::Sphere(rt::Point(-3, 20, -3), 3, rt::Texture(rt::color::WHITE, rt::color(0, 255, 255), 1000, 0, 1)));
